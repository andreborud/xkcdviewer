...
class SaveComicLocalUseCaseTest {

    private lateinit var saveComicLocalUseCase: SaveComicLocalUseCase
    private lateinit var mockRepository: ComicsLocalRepository

    @Before
    fun setup() {
        mockRepository = mockk(relaxed = true)
        saveComicLocalUseCase = SaveComicLocalUseCase(mockRepository)
    }

    @Test
    fun testSaveComic() = runBlocking {
        val comicToSave = XkcdComic(
            month = "11",
            num = 853,
            link = "",
            year = "2023",
        ...
        saveComicLocalUseCase.invoke(comicToSave)
